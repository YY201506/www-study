...
var defaults = {
    ...
    "width": "900",
    "height": "500",
    "list": ['shop_act/wsj.jpg', 'shop_act/kt.jpg', 'shop_act/zw.jpg', 'shop_act/cf.jpg', 'shop_act/ct.jpg', 'shop_act/etf.jpg'],
...
var banner2 = new fullbanner(defaults2);
...
function fullbanner(obj) {
    ...
    var main = '';
    main = '<div class="base-slide" style="width:'+obj.width+'px;height:'+obj.height+'px;margin-left: '+(obj.width/2)+'px"><div class="base-temp" style="width:'+obj.width+'px;height:'+obj.height+'px"><div class="button_pre" style="margin-left:-'+(obj.width-3)+'px "></div><div class="button_next"></div><div class="temp-wrap" style="left: 0px;"><ul id="img_con" class="clearfix" style="left:-'+obj.width+'px;margin-left:-'+obj.width+'px!important;">';
